...
import { InteractionType, InteractionResponseType, APIInteractionResponse, MessageFlags } from 'discord-api-types/v10'

export type DiscordInteractionResponse = APIInteractionResponse | { error: string };
