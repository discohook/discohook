...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1694805174982.7734";
}
var copyText = (text) => {
...
var base64Decode = (urlSafeBase64) => {
  const base64 = urlSafeBase64.replace(/-/g, "+").replace(/_/g, "/");
  if (typeof window === "undefined") {
    return Buffer.from(base64, "base64").toString("utf8");
  }
  try {
    const encoded = atob(base64).split("").map((char) => char.charCodeAt(0).toString(16)).map((hex2) => `%${hex2.padStart(2, "0").slice(-2)}`).join("");
    return decodeURIComponent(encoded);
  } catch {
  }
};
var base64Encode = (utf8) => {
  if (typeof window === "undefined") {
    return Buffer.from(utf8, "utf8").toString("base64");
  }
  const encoded = encodeURIComponent(utf8);
  const escaped = encoded.replace(/%[\dA-F]{2}/g, (hex2) => {
    return String.fromCharCode(Number.parseInt(hex2.slice(1), 16));
  });
  return btoa(escaped);
};
var base64UrlEncode = (utf8) => {
  return base64Encode(utf8).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, "");
};
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1696038458916.7612";
}
var TextInput = (props) => {
  _s();
  const {
  ...
  const [timeoutId, setTimeoutId] = (0, import_react.useState)();
  const newProps = {
    ...props
  };
  delete newProps.delayOnInput;
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("label", { className: "block", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-sm font-medium flex", children: [
      label,
      props.maxLength && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("span", { className: "ml-auto", children: [
        "max. ",
        props.maxLength
      ] }, void 0, true, {
    ...
    props.description && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-sm", children: props.description }, void 0, false, {
      fileName: "app/components/TextInput.tsx",
      lineNumber: 43,
      columnNumber: 29
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { type: "text", ...newProps, onInput: (e) => {
      const event = {
        ...e
      };
      if (timeoutId) {
    ...
    }, className: `rounded border min-h-[36px] max-h-9 py-0 px-[14px] bg-gray-300 border-gray-200 placeholder-gray-500 focus:border-blurple-500 dark:border-transparent dark:bg-[#292b2f] dark:placeholder-gray-400 invalid:border-rose-400 dark:invalid:border-rose-400 transition ${props.className ?? ""}` }, void 0, false, {
      fileName: "app/components/TextInput.tsx",
      lineNumber: 44,
      columnNumber: 7
    }, this),
    props.errors && props.errors.filter((e) => e !== void 0).map((error, i) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("p", { className: "text-rose-500 dark:text-rose-300 font-medium mt-1 text-sm", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(CoolIcon, { icon: "Circle_Warning", className: "mr-1.5" }, void 0, false, {
        fileName: "app/components/TextInput.tsx",
        lineNumber: 66,
        columnNumber: 13
      }, this),
...
_s(TextInput, "0WwKClxy2nB6olKEZM9FkT6Zw1I=");
_c = TextInput;
var _c;
...
@remix-run/server-runtime/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-22RUGG5T.js.map
