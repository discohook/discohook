    ...
    translation: {
      ...
      timestamp: {
        ...
        relative: {
          ...
          minutes_future: "بعد {{count}} دقائق",
          minutes_past: "منذ {{count}} دقائف",
          hours_future: "بعد {{count}} ساعات",
          hours_past: "منذ {{count}} ساعات",
          days_future: "بعد {{count}} ايام",
          days_past: "منذ {{count}} ايام",
          months_future: "بعد {{count}} شهور",
          months_past: "منذ {{count}} شهور",
          years_future: "بعد {{count}} سنوات",
          years_past: "منذ {{count}} سنوات",
        },
      },
    },
  },
