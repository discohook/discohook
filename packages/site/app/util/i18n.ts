  ...
  ar: {
    translation: {
      ...
      timestamp: {
        ...
        date_verbose: "{{ date, MMMM D, YYYY }}",
        relative: {
          seconds_future: "بعد {{n}} ثواني ",
          seconds_past: "منذ {{n}} ثواني",
          minutes_future: "بعد {{n}} دقائق",
          minutes_past: "منذ {{n}} دقائف",
          hours_future: "بعد {{n}} ساعات",
          hours_past: "منذ {{n}} ساعات",
          days_future: "بعد {{n}} ايام",
          days_past: "منذ {{n}} ايام",
          months_future: "بعد {{n}} شهور",
          months_past: "منذ {{n}} شهور",
          years_future: "بعد {{n}} سنوات",
          years_past: "منذ {{n}} سنوات",
        },
      },
    },
  },
