...
(async () => {
  ...
  console.log(
    "Wrote index of",
    contents.length,
    "guide items (directories included)",
  );
})();
...
(async () => {
  ...
  await writeFile("public/news-index.json", JSON.stringify(folders));
  console.log("Wrote index of", contents.length, "news items");
})();
