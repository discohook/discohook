// This is temporary! In the future we will use data generated by the site
...
export const emojiData = {
  people: [
    ...
    { names: ["smiling_face_with_tear"], surrogates: "🥲" },
    { names: ["heart_eyes"], surrogates: "😍" },
    { names: ["smiling_face_with_3_hearts"], surrogates: "🥰" },
    ...
    { names: ["zany_face"], surrogates: "🤪" },
    { names: ["face_with_raised_eyebrow"], surrogates: "🤨" },
    { names: ["face_with_monocle"], surrogates: "🧐" },
    { names: ["nerd", "nerd_face"], surrogates: "🤓" },
    { names: ["sunglasses"], surrogates: "😎" },
    { names: ["star_struck"], surrogates: "🤩" },
    { names: ["partying_face"], surrogates: "🥳" },
    ...
    { names: ["frowning2", "white_frowning_face"], surrogates: "☹️" },
    { names: ["persevere"], surrogates: "😣" },
    { names: ["confounded"], surrogates: "😖" },
    { names: ["tired_face"], surrogates: "😫" },
    { names: ["weary"], surrogates: "😩" },
    { names: ["pleading_face"], surrogates: "🥺" },
    { names: ["cry"], surrogates: "😢" },
    { names: ["sob"], surrogates: "😭" },
    { names: ["triumph"], surrogates: "😤" },
    { names: ["face_exhaling"], surrogates: "😮‍💨" },
    { names: ["angry"], surrogates: "😠" },
    { names: ["rage"], surrogates: "😡" },
    { names: ["face_with_symbols_over_mouth"], surrogates: "🤬" },
    { names: ["exploding_head"], surrogates: "🤯" },
    { names: ["flushed"], surrogates: "😳" },
    { names: ["face_in_clouds"], surrogates: "😶‍🌫️" },
    { names: ["hot_face"], surrogates: "🥵" },
    { names: ["cold_face"], surrogates: "🥶" },
    ...
    { names: ["face_with_hand_over_mouth"], surrogates: "🤭" },
    { names: ["yawning_face"], surrogates: "🥱" },
    { names: ["shushing_face"], surrogates: "🤫" },
    ...
    { names: ["face_with_spiral_eyes"], surrogates: "😵‍💫" },
    { names: ["zipper_mouth", "zipper_mouth_face"], surrogates: "🤐" },
    { names: ["woozy_face"], surrogates: "🥴" },
    { names: ["nauseated_face", "sick"], surrogates: "🤢" },
    { names: ["face_vomiting"], surrogates: "🤮" },
    ...
    { names: ["disguised_face"], surrogates: "🥸" },
    ...
    { names: ["skull_crossbones", "skull_and_crossbones"], surrogates: "☠️" },
    ...
    },
    {
      ...
      surrogates: "👐",
      diversityChildren: [
        { names: ["open_hands_tone1"], surrogates: "👐🏻" },
        { names: ["open_hands_tone2"], surrogates: "👐🏼" },
        { names: ["open_hands_tone3"], surrogates: "👐🏽" },
        { names: ["open_hands_tone4"], surrogates: "👐🏾" },
        { names: ["open_hands_tone5"], surrogates: "👐🏿" },
      ],
    },
    {
      names: ["raised_hands"],
      surrogates: "🙌",
      diversityChildren: [
        { names: ["raised_hands_tone1"], surrogates: "🙌🏻" },
        { names: ["raised_hands_tone2"], surrogates: "🙌🏼" },
        { names: ["raised_hands_tone3"], surrogates: "🙌🏽" },
        { names: ["raised_hands_tone4"], surrogates: "🙌🏾" },
        { names: ["raised_hands_tone5"], surrogates: "🙌🏿" },
      ],
    },
    {
      names: ["clap"],
      surrogates: "👏",
      diversityChildren: [
        { names: ["clap_tone1"], surrogates: "👏🏻" },
        { names: ["clap_tone2"], surrogates: "👏🏼" },
        { names: ["clap_tone3"], surrogates: "👏🏽" },
        { names: ["clap_tone4"], surrogates: "👏🏾" },
        { names: ["clap_tone5"], surrogates: "👏🏿" },
      ],
    },
    ...
    },
    {
      ...
      surrogates: "👊",
      diversityChildren: [
        { names: ["punch_tone1"], surrogates: "👊🏻" },
        { names: ["punch_tone2"], surrogates: "👊🏼" },
        { names: ["punch_tone3"], surrogates: "👊🏽" },
        { names: ["punch_tone4"], surrogates: "👊🏾" },
        { names: ["punch_tone5"], surrogates: "👊🏿" },
      ],
    },
    {
      names: ["fist"],
      surrogates: "✊",
      diversityChildren: [
        { names: ["fist_tone1"], surrogates: "✊🏻" },
        { names: ["fist_tone2"], surrogates: "✊🏼" },
        { names: ["fist_tone3"], surrogates: "✊🏽" },
        { names: ["fist_tone4"], surrogates: "✊🏾" },
        { names: ["fist_tone5"], surrogates: "✊🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "✌️",
      diversityChildren: [
        { names: ["v_tone1"], surrogates: "✌🏻" },
        { names: ["v_tone2"], surrogates: "✌🏼" },
        { names: ["v_tone3"], surrogates: "✌🏽" },
        { names: ["v_tone4"], surrogates: "✌🏾" },
        { names: ["v_tone5"], surrogates: "✌🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "👌",
      diversityChildren: [
        { names: ["ok_hand_tone1"], surrogates: "👌🏻" },
        { names: ["ok_hand_tone2"], surrogates: "👌🏼" },
        { names: ["ok_hand_tone3"], surrogates: "👌🏽" },
        { names: ["ok_hand_tone4"], surrogates: "👌🏾" },
        { names: ["ok_hand_tone5"], surrogates: "👌🏿" },
      ],
    },
    {
      names: ["pinching_hand"],
    ...
    },
    {
      ...
      surrogates: "👈",
      diversityChildren: [
        { names: ["point_left_tone1"], surrogates: "👈🏻" },
        { names: ["point_left_tone2"], surrogates: "👈🏼" },
        { names: ["point_left_tone3"], surrogates: "👈🏽" },
        { names: ["point_left_tone4"], surrogates: "👈🏾" },
        { names: ["point_left_tone5"], surrogates: "👈🏿" },
      ],
    },
    {
      names: ["point_right"],
      surrogates: "👉",
      diversityChildren: [
        { names: ["point_right_tone1"], surrogates: "👉🏻" },
        { names: ["point_right_tone2"], surrogates: "👉🏼" },
        { names: ["point_right_tone3"], surrogates: "👉🏽" },
        { names: ["point_right_tone4"], surrogates: "👉🏾" },
        { names: ["point_right_tone5"], surrogates: "👉🏿" },
      ],
    },
    {
      names: ["point_up_2"],
      surrogates: "👆",
      diversityChildren: [
        { names: ["point_up_2_tone1"], surrogates: "👆🏻" },
        { names: ["point_up_2_tone2"], surrogates: "👆🏼" },
        { names: ["point_up_2_tone3"], surrogates: "👆🏽" },
        { names: ["point_up_2_tone4"], surrogates: "👆🏾" },
        { names: ["point_up_2_tone5"], surrogates: "👆🏿" },
      ],
    },
    {
      names: ["point_down"],
      surrogates: "👇",
      diversityChildren: [
        { names: ["point_down_tone1"], surrogates: "👇🏻" },
        { names: ["point_down_tone2"], surrogates: "👇🏼" },
        { names: ["point_down_tone3"], surrogates: "👇🏽" },
        { names: ["point_down_tone4"], surrogates: "👇🏾" },
        { names: ["point_down_tone5"], surrogates: "👇🏿" },
      ],
    },
    {
      names: ["point_up"],
      surrogates: "☝️",
      diversityChildren: [
        { names: ["point_up_tone1"], surrogates: "☝🏻" },
        { names: ["point_up_tone2"], surrogates: "☝🏼" },
        { names: ["point_up_tone3"], surrogates: "☝🏽" },
        { names: ["point_up_tone4"], surrogates: "☝🏾" },
        { names: ["point_up_tone5"], surrogates: "☝🏿" },
      ],
    },
    {
      names: ["raised_hand"],
      surrogates: "✋",
      diversityChildren: [
        { names: ["raised_hand_tone1"], surrogates: "✋🏻" },
        { names: ["raised_hand_tone2"], surrogates: "✋🏼" },
        { names: ["raised_hand_tone3"], surrogates: "✋🏽" },
        { names: ["raised_hand_tone4"], surrogates: "✋🏾" },
        { names: ["raised_hand_tone5"], surrogates: "✋🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "👋",
      diversityChildren: [
        { names: ["wave_tone1"], surrogates: "👋🏻" },
        { names: ["wave_tone2"], surrogates: "👋🏼" },
        { names: ["wave_tone3"], surrogates: "👋🏽" },
        { names: ["wave_tone4"], surrogates: "👋🏾" },
        { names: ["wave_tone5"], surrogates: "👋🏿" },
      ],
    },
    {
      ...
      surrogates: "🤙",
      diversityChildren: [
        { names: ["call_me_tone1", "call_me_hand_tone1"], surrogates: "🤙🏻" },
        { names: ["call_me_tone2", "call_me_hand_tone2"], surrogates: "🤙🏼" },
        { names: ["call_me_tone3", "call_me_hand_tone3"], surrogates: "🤙🏽" },
        { names: ["call_me_tone4", "call_me_hand_tone4"], surrogates: "🤙🏾" },
        { names: ["call_me_tone5", "call_me_hand_tone5"], surrogates: "🤙🏿" },
      ],
    },
    {
      names: ["muscle"],
      surrogates: "💪",
      diversityChildren: [
        { names: ["muscle_tone1"], surrogates: "💪🏻" },
        { names: ["muscle_tone2"], surrogates: "💪🏼" },
        { names: ["muscle_tone3"], surrogates: "💪🏽" },
        { names: ["muscle_tone4"], surrogates: "💪🏾" },
        { names: ["muscle_tone5"], surrogates: "💪🏿" },
      ],
    },
    { names: ["mechanical_arm"], surrogates: "🦾" },
    {
    ...
    },
    {
      ...
      surrogates: "✍️",
      diversityChildren: [
        { names: ["writing_hand_tone1"], surrogates: "✍🏻" },
        { names: ["writing_hand_tone2"], surrogates: "✍🏼" },
        { names: ["writing_hand_tone3"], surrogates: "✍🏽" },
        { names: ["writing_hand_tone4"], surrogates: "✍🏾" },
        { names: ["writing_hand_tone5"], surrogates: "✍🏿" },
      ],
    },
    {
      names: ["pray"],
      surrogates: "🙏",
      diversityChildren: [
        { names: ["pray_tone1"], surrogates: "🙏🏻" },
        { names: ["pray_tone2"], surrogates: "🙏🏼" },
        { names: ["pray_tone3"], surrogates: "🙏🏽" },
        { names: ["pray_tone4"], surrogates: "🙏🏾" },
        { names: ["pray_tone5"], surrogates: "🙏🏿" },
      ],
    },
    {
      names: ["foot"],
      surrogates: "🦶",
      diversityChildren: [
        { names: ["foot_tone1", "foot_light_skin_tone"], surrogates: "🦶🏻" },
        {
          names: ["foot_tone2", "foot_medium_light_skin_tone"],
          surrogates: "🦶🏼",
        },
        { names: ["foot_tone3", "foot_medium_skin_tone"], surrogates: "🦶🏽" },
        {
          names: ["foot_tone4", "foot_medium_dark_skin_tone"],
          surrogates: "🦶🏾",
        },
        { names: ["foot_tone5", "foot_dark_skin_tone"], surrogates: "🦶🏿" },
      ],
    },
    {
      names: ["leg"],
      surrogates: "🦵",
      diversityChildren: [
        { names: ["leg_tone1", "leg_light_skin_tone"], surrogates: "🦵🏻" },
        {
          names: ["leg_tone2", "leg_medium_light_skin_tone"],
          surrogates: "🦵🏼",
        },
        { names: ["leg_tone3", "leg_medium_skin_tone"], surrogates: "🦵🏽" },
        {
          names: ["leg_tone4", "leg_medium_dark_skin_tone"],
          surrogates: "🦵🏾",
        },
        { names: ["leg_tone5", "leg_dark_skin_tone"], surrogates: "🦵🏿" },
      ],
    },
    { names: ["mechanical_leg"], surrogates: "🦿" },
    { names: ["lipstick"], surrogates: "💄" },
    { names: ["kiss"], surrogates: "💋" },
    { names: ["lips"], surrogates: "👄" },
    { names: ["tooth"], surrogates: "🦷" },
    { names: ["tongue"], surrogates: "👅" },
    {
      names: ["ear"],
      surrogates: "👂",
      diversityChildren: [
        { names: ["ear_tone1"], surrogates: "👂🏻" },
        { names: ["ear_tone2"], surrogates: "👂🏼" },
        { names: ["ear_tone3"], surrogates: "👂🏽" },
        { names: ["ear_tone4"], surrogates: "👂🏾" },
        { names: ["ear_tone5"], surrogates: "👂🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "👃",
      diversityChildren: [
        { names: ["nose_tone1"], surrogates: "👃🏻" },
        { names: ["nose_tone2"], surrogates: "👃🏼" },
        { names: ["nose_tone3"], surrogates: "👃🏽" },
        { names: ["nose_tone4"], surrogates: "👃🏾" },
        { names: ["nose_tone5"], surrogates: "👃🏿" },
      ],
    },
    { names: ["footprints"], surrogates: "👣" },
    { names: ["eye"], surrogates: "👁️" },
    { names: ["eyes"], surrogates: "👀" },
    { names: ["brain"], surrogates: "🧠" },
    { names: ["anatomical_heart"], surrogates: "🫀" },
    { names: ["lungs"], surrogates: "🫁" },
    { names: ["bone"], surrogates: "🦴" },
    {
    ...
    { names: ["people_hugging"], surrogates: "🫂" },
    {
      names: ["baby"],
      surrogates: "👶",
      diversityChildren: [
        { names: ["baby_tone1"], surrogates: "👶🏻" },
        { names: ["baby_tone2"], surrogates: "👶🏼" },
        { names: ["baby_tone3"], surrogates: "👶🏽" },
        { names: ["baby_tone4"], surrogates: "👶🏾" },
        { names: ["baby_tone5"], surrogates: "👶🏿" },
      ],
    },
    {
      names: ["girl"],
      surrogates: "👧",
      diversityChildren: [
        { names: ["girl_tone1"], surrogates: "👧🏻" },
        { names: ["girl_tone2"], surrogates: "👧🏼" },
        { names: ["girl_tone3"], surrogates: "👧🏽" },
        { names: ["girl_tone4"], surrogates: "👧🏾" },
        { names: ["girl_tone5"], surrogates: "👧🏿" },
      ],
    },
    {
      names: ["child"],
      surrogates: "🧒",
      diversityChildren: [
        { names: ["child_tone1", "child_light_skin_tone"], surrogates: "🧒🏻" },
        {
        ...
        { names: ["child_tone5", "child_dark_skin_tone"], surrogates: "🧒🏿" },
      ],
    },
    {
      names: ["boy"],
      surrogates: "👦",
      diversityChildren: [
        { names: ["boy_tone1"], surrogates: "👦🏻" },
        { names: ["boy_tone2"], surrogates: "👦🏼" },
        { names: ["boy_tone3"], surrogates: "👦🏽" },
        { names: ["boy_tone4"], surrogates: "👦🏾" },
        { names: ["boy_tone5"], surrogates: "👦🏿" },
      ],
    },
    {
      names: ["woman"],
      surrogates: "👩",
      diversityChildren: [
        { names: ["woman_tone1"], surrogates: "👩🏻" },
        { names: ["woman_tone2"], surrogates: "👩🏼" },
        { names: ["woman_tone3"], surrogates: "👩🏽" },
        { names: ["woman_tone4"], surrogates: "👩🏾" },
        { names: ["woman_tone5"], surrogates: "👩🏿" },
      ],
    },
    {
      names: ["adult"],
      surrogates: "🧑",
      diversityChildren: [
        { names: ["adult_tone1", "adult_light_skin_tone"], surrogates: "🧑🏻" },
        {
        ...
        { names: ["adult_tone5", "adult_dark_skin_tone"], surrogates: "🧑🏿" },
      ],
    },
    {
      names: ["man"],
      surrogates: "👨",
      diversityChildren: [
        { names: ["man_tone1"], surrogates: "👨🏻" },
        { names: ["man_tone2"], surrogates: "👨🏼" },
        { names: ["man_tone3"], surrogates: "👨🏽" },
        { names: ["man_tone4"], surrogates: "👨🏾" },
        { names: ["man_tone5"], surrogates: "👨🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "👵",
      diversityChildren: [
        { names: ["older_woman_tone1", "grandma_tone1"], surrogates: "👵🏻" },
        { names: ["older_woman_tone2", "grandma_tone2"], surrogates: "👵🏼" },
        { names: ["older_woman_tone3", "grandma_tone3"], surrogates: "👵🏽" },
        { names: ["older_woman_tone4", "grandma_tone4"], surrogates: "👵🏾" },
        { names: ["older_woman_tone5", "grandma_tone5"], surrogates: "👵🏿" },
      ],
    },
    {
      names: ["older_adult"],
    ...
    },
    {
      ...
      surrogates: "👴",
      diversityChildren: [
        { names: ["older_man_tone1"], surrogates: "👴🏻" },
        { names: ["older_man_tone2"], surrogates: "👴🏼" },
        { names: ["older_man_tone3"], surrogates: "👴🏽" },
        { names: ["older_man_tone4"], surrogates: "👴🏾" },
        { names: ["older_man_tone5"], surrogates: "👴🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "👮",
      diversityChildren: [
        { names: ["police_officer_tone1", "cop_tone1"], surrogates: "👮🏻" },
        { names: ["police_officer_tone2", "cop_tone2"], surrogates: "👮🏼" },
        { names: ["police_officer_tone3", "cop_tone3"], surrogates: "👮🏽" },
        { names: ["police_officer_tone4", "cop_tone4"], surrogates: "👮🏾" },
        { names: ["police_officer_tone5", "cop_tone5"], surrogates: "👮🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "👷",
      diversityChildren: [
        { names: ["construction_worker_tone1"], surrogates: "👷🏻" },
        { names: ["construction_worker_tone2"], surrogates: "👷🏼" },
        { names: ["construction_worker_tone3"], surrogates: "👷🏽" },
        { names: ["construction_worker_tone4"], surrogates: "👷🏾" },
        { names: ["construction_worker_tone5"], surrogates: "👷🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "💂",
      diversityChildren: [
        { names: ["guard_tone1", "guardsman_tone1"], surrogates: "💂🏻" },
        { names: ["guard_tone2", "guardsman_tone2"], surrogates: "💂🏼" },
        { names: ["guard_tone3", "guardsman_tone3"], surrogates: "💂🏽" },
        { names: ["guard_tone4", "guardsman_tone4"], surrogates: "💂🏾" },
        { names: ["guard_tone5", "guardsman_tone5"], surrogates: "💂🏿" },
      ],
    },
    {
      names: ["woman_guard"],
    ...
    },
    {
      ...
      surrogates: "🧑‍🍳",
      diversityChildren: [
        { names: ["cook_tone1", "cook_light_skin_tone"], surrogates: "🧑🏻‍🍳" },
        {
        ...
        { names: ["cook_tone5", "cook_dark_skin_tone"], surrogates: "🧑🏿‍🍳" },
      ],
    },
    {
      names: ["woman_cook"],
    ...
    },
    {
      ...
      diversityChildren: [
        ...
        { names: ["pilot_tone5", "pilot_dark_skin_tone"], surrogates: "🧑🏿‍✈️" },
      ],
    },
    {
      names: ["woman_pilot"],
    ...
    },
    {
      ...
      diversityChildren: [
        ...
        { names: ["judge_tone5", "judge_dark_skin_tone"], surrogates: "🧑🏿‍⚖️" },
      ],
    },
    {
      names: ["woman_judge"],
    ...
    },
    {
      ...
      surrogates: "👰",
      diversityChildren: [
        { names: ["person_with_veil_tone1"], surrogates: "👰🏻" },
        { names: ["person_with_veil_tone2"], surrogates: "👰🏼" },
        { names: ["person_with_veil_tone3"], surrogates: "👰🏽" },
        { names: ["person_with_veil_tone4"], surrogates: "👰🏾" },
        { names: ["person_with_veil_tone5"], surrogates: "👰🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "👸",
      diversityChildren: [
        { names: ["princess_tone1"], surrogates: "👸🏻" },
        { names: ["princess_tone2"], surrogates: "👸🏼" },
        { names: ["princess_tone3"], surrogates: "👸🏽" },
        { names: ["princess_tone4"], surrogates: "👸🏾" },
        { names: ["princess_tone5"], surrogates: "👸🏿" },
      ],
    },
    {
      names: ["prince"],
      surrogates: "🤴",
      diversityChildren: [
        { names: ["prince_tone1"], surrogates: "🤴🏻" },
        { names: ["prince_tone2"], surrogates: "🤴🏼" },
        { names: ["prince_tone3"], surrogates: "🤴🏽" },
        { names: ["prince_tone4"], surrogates: "🤴🏾" },
        { names: ["prince_tone5"], surrogates: "🤴🏿" },
      ],
    },
    {
      names: ["superhero"],
    ...
    },
    {
      ...
      surrogates: "🥷",
      diversityChildren: [
        { names: ["ninja_tone1", "ninja_light_skin_tone"], surrogates: "🥷🏻" },
        {
        ...
        { names: ["ninja_tone5", "ninja_dark_skin_tone"], surrogates: "🥷🏿" },
      ],
    },
    {
      names: ["mx_claus"],
    ...
    },
    {
      ...
      surrogates: "🎅",
      diversityChildren: [
        { names: ["santa_tone1"], surrogates: "🎅🏻" },
        { names: ["santa_tone2"], surrogates: "🎅🏼" },
        { names: ["santa_tone3"], surrogates: "🎅🏽" },
        { names: ["santa_tone4"], surrogates: "🎅🏾" },
        { names: ["santa_tone5"], surrogates: "🎅🏿" },
      ],
    },
    {
      names: ["mage"],
      surrogates: "🧙",
      diversityChildren: [
        { names: ["mage_tone1", "mage_light_skin_tone"], surrogates: "🧙🏻" },
        {
          names: ["mage_tone2", "mage_medium_light_skin_tone"],
          surrogates: "🧙🏼",
        },
        { names: ["mage_tone3", "mage_medium_skin_tone"], surrogates: "🧙🏽" },
        {
          names: ["mage_tone4", "mage_medium_dark_skin_tone"],
          surrogates: "🧙🏾",
        },
        { names: ["mage_tone5", "mage_dark_skin_tone"], surrogates: "🧙🏿" },
      ],
    },
    {
      names: ["woman_mage"],
    ...
    },
    {
      ...
      surrogates: "🧝",
      diversityChildren: [
        { names: ["elf_tone1", "elf_light_skin_tone"], surrogates: "🧝🏻" },
        {
          names: ["elf_tone2", "elf_medium_light_skin_tone"],
          surrogates: "🧝🏼",
        },
        { names: ["elf_tone3", "elf_medium_skin_tone"], surrogates: "🧝🏽" },
        {
          names: ["elf_tone4", "elf_medium_dark_skin_tone"],
          surrogates: "🧝🏾",
        },
        { names: ["elf_tone5", "elf_dark_skin_tone"], surrogates: "🧝🏿" },
      ],
    },
    {
      names: ["woman_elf"],
    ...
    { names: ["zombie"], surrogates: "🧟" },
    { names: ["woman_zombie"], surrogates: "🧟‍♀️" },
    { names: ["man_zombie"], surrogates: "🧟‍♂️" },
    { names: ["genie"], surrogates: "🧞" },
    { names: ["woman_genie"], surrogates: "🧞‍♀️" },
    { names: ["man_genie"], surrogates: "🧞‍♂️" },
    {
      names: ["merperson"],
      surrogates: "🧜",
      diversityChildren: [
    ...
    },
    {
      ...
      surrogates: "🧚",
      diversityChildren: [
        { names: ["fairy_tone1", "fairy_light_skin_tone"], surrogates: "🧚🏻" },
        {
        ...
        { names: ["fairy_tone5", "fairy_dark_skin_tone"], surrogates: "🧚🏿" },
      ],
    },
    {
      names: ["woman_fairy"],
    ...
    },
    {
      ...
      surrogates: "👼",
      diversityChildren: [
        { names: ["angel_tone1"], surrogates: "👼🏻" },
        { names: ["angel_tone2"], surrogates: "👼🏼" },
        { names: ["angel_tone3"], surrogates: "👼🏽" },
        { names: ["angel_tone4"], surrogates: "👼🏾" },
        { names: ["angel_tone5"], surrogates: "👼🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "🙇",
      diversityChildren: [
        { names: ["person_bowing_tone1", "bow_tone1"], surrogates: "🙇🏻" },
        { names: ["person_bowing_tone2", "bow_tone2"], surrogates: "🙇🏼" },
        { names: ["person_bowing_tone3", "bow_tone3"], surrogates: "🙇🏽" },
        { names: ["person_bowing_tone4", "bow_tone4"], surrogates: "🙇🏾" },
        { names: ["person_bowing_tone5", "bow_tone5"], surrogates: "🙇🏿" },
      ],
    },
    {
      names: ["woman_bowing"],
    ...
    },
    {
      ...
      surrogates: "🙍",
      diversityChildren: [
        { names: ["person_frowning_tone1"], surrogates: "🙍🏻" },
        { names: ["person_frowning_tone2"], surrogates: "🙍🏼" },
        { names: ["person_frowning_tone3"], surrogates: "🙍🏽" },
        { names: ["person_frowning_tone4"], surrogates: "🙍🏾" },
        { names: ["person_frowning_tone5"], surrogates: "🙍🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "💅",
      diversityChildren: [
        { names: ["nail_care_tone1"], surrogates: "💅🏻" },
        { names: ["nail_care_tone2"], surrogates: "💅🏼" },
        { names: ["nail_care_tone3"], surrogates: "💅🏽" },
        { names: ["nail_care_tone4"], surrogates: "💅🏾" },
        { names: ["nail_care_tone5"], surrogates: "💅🏿" },
      ],
    },
    {
      names: ["selfie"],
      surrogates: "🤳",
      diversityChildren: [
        { names: ["selfie_tone1"], surrogates: "🤳🏻" },
        { names: ["selfie_tone2"], surrogates: "🤳🏼" },
        { names: ["selfie_tone3"], surrogates: "🤳🏽" },
        { names: ["selfie_tone4"], surrogates: "🤳🏾" },
        { names: ["selfie_tone5"], surrogates: "🤳🏿" },
      ],
    },
    {
      names: ["dancer"],
      surrogates: "💃",
      diversityChildren: [
        { names: ["dancer_tone1"], surrogates: "💃🏻" },
        { names: ["dancer_tone2"], surrogates: "💃🏼" },
        { names: ["dancer_tone3"], surrogates: "💃🏽" },
        { names: ["dancer_tone4"], surrogates: "💃🏾" },
        { names: ["dancer_tone5"], surrogates: "💃🏿" },
      ],
    },
    {
    ...
    { names: ["people_with_bunny_ears_partying", "dancers"], surrogates: "👯" },
    { names: ["women_with_bunny_ears_partying"], surrogates: "👯‍♀️" },
    { names: ["men_with_bunny_ears_partying"], surrogates: "👯‍♂️" },
    {
    ...
    },
    {
      ...
      surrogates: "🏃",
      diversityChildren: [
        { names: ["person_running_tone1", "runner_tone1"], surrogates: "🏃🏻" },
        { names: ["person_running_tone2", "runner_tone2"], surrogates: "🏃🏼" },
        { names: ["person_running_tone3", "runner_tone3"], surrogates: "🏃🏽" },
        { names: ["person_running_tone4", "runner_tone4"], surrogates: "🏃🏾" },
        { names: ["person_running_tone5", "runner_tone5"], surrogates: "🏃🏿" },
      ],
    },
    {
      names: ["woman_running"],
    ...
    },
    {
      ...
      diversityChildren: [
        ...
        { names: ["kiss_tone1", "kiss_light_skin_tone"], surrogates: "💏🏻" },
        {
          names: [
        ...
        { names: ["kiss_tone3", "kiss_medium_skin_tone"], surrogates: "💏🏽" },
        {
          names: [
        ...
        { names: ["kiss_tone5", "kiss_dark_skin_tone"], surrogates: "💏🏿" },
      ],
    },
    {
    ...
    { names: ["family_man_woman_boy"], surrogates: "👨‍👩‍👦" },
    { names: ["family_mwg"], surrogates: "👨‍👩‍👧" },
    { names: ["family_mwgb"], surrogates: "👨‍👩‍👧‍👦" },
    { names: ["family_mwbb"], surrogates: "👨‍👩‍👦‍👦" },
    { names: ["family_mwgg"], surrogates: "👨‍👩‍👧‍👧" },
    { names: ["family_wwb"], surrogates: "👩‍👩‍👦" },
    { names: ["family_wwg"], surrogates: "👩‍👩‍👧" },
    { names: ["family_wwgb"], surrogates: "👩‍👩‍👧‍👦" },
    { names: ["family_wwbb"], surrogates: "👩‍👩‍👦‍👦" },
    { names: ["family_wwgg"], surrogates: "👩‍👩‍👧‍👧" },
    { names: ["family_mmb"], surrogates: "👨‍👨‍👦" },
    { names: ["family_mmg"], surrogates: "👨‍👨‍👧" },
    { names: ["family_mmgb"], surrogates: "👨‍👨‍👧‍👦" },
    { names: ["family_mmbb"], surrogates: "👨‍👨‍👦‍👦" },
    { names: ["family_mmgg"], surrogates: "👨‍👨‍👧‍👧" },
    { names: ["family_woman_boy"], surrogates: "👩‍👦" },
    { names: ["family_woman_girl"], surrogates: "👩‍👧" },
    { names: ["family_woman_girl_boy"], surrogates: "👩‍👧‍👦" },
    { names: ["family_woman_boy_boy"], surrogates: "👩‍👦‍👦" },
    { names: ["family_woman_girl_girl"], surrogates: "👩‍👧‍👧" },
    { names: ["family_man_boy"], surrogates: "👨‍👦" },
    { names: ["family_man_girl"], surrogates: "👨‍👧" },
    { names: ["family_man_girl_boy"], surrogates: "👨‍👧‍👦" },
    { names: ["family_man_boy_boy"], surrogates: "👨‍👦‍👦" },
    { names: ["family_man_girl_girl"], surrogates: "👨‍👧‍👧" },
    { names: ["yarn"], surrogates: "🧶" },
    { names: ["thread"], surrogates: "🧵" },
    { names: ["coat"], surrogates: "🧥" },
    { names: ["lab_coat"], surrogates: "🥼" },
    { names: ["safety_vest"], surrogates: "🦺" },
    { names: ["womans_clothes"], surrogates: "👚" },
    { names: ["shirt"], surrogates: "👕" },
    { names: ["jeans"], surrogates: "👖" },
    { names: ["briefs"], surrogates: "🩲" },
    { names: ["shorts"], surrogates: "🩳" },
    { names: ["necktie"], surrogates: "👔" },
    { names: ["dress"], surrogates: "👗" },
    { names: ["bikini"], surrogates: "👙" },
    { names: ["one_piece_swimsuit"], surrogates: "🩱" },
    { names: ["kimono"], surrogates: "👘" },
    { names: ["sari"], surrogates: "🥻" },
    { names: ["womans_flat_shoe"], surrogates: "🥿" },
    ...
    { names: ["hiking_boot"], surrogates: "🥾" },
    { names: ["thong_sandal"], surrogates: "🩴" },
    { names: ["socks"], surrogates: "🧦" },
    { names: ["gloves"], surrogates: "🧤" },
    { names: ["scarf"], surrogates: "🧣" },
    { names: ["tophat"], surrogates: "🎩" },
    { names: ["billed_cap"], surrogates: "🧢" },
    ...
    { names: ["military_helmet"], surrogates: "🪖" },
    ...
    { names: ["luggage"], surrogates: "🧳" },
    { names: ["eyeglasses"], surrogates: "👓" },
    { names: ["dark_sunglasses"], surrogates: "🕶️" },
    { names: ["goggles"], surrogates: "🥽" },
  ...
  nature: [
    ...
    { names: ["llama"], surrogates: "🦙" },
    { names: ["goat"], surrogates: "🐐" },
    { names: ["deer"], surrogates: "🦌" },
    { names: ["dog2"], surrogates: "🐕" },
    { names: ["poodle"], surrogates: "🐩" },
    { names: ["guide_dog"], surrogates: "🦮" },
    { names: ["service_dog"], surrogates: "🐕‍🦺" },
    { names: ["cat2"], surrogates: "🐈" },
    { names: ["black_cat"], surrogates: "🐈‍⬛" },
    { names: ["rooster"], surrogates: "🐓" },
    { names: ["turkey"], surrogates: "🦃" },
    { names: ["peacock"], surrogates: "🦚" },
    { names: ["parrot"], surrogates: "🦜" },
    { names: ["swan"], surrogates: "🦢" },
    { names: ["flamingo"], surrogates: "🦩" },
    { names: ["dove", "dove_of_peace"], surrogates: "🕊️" },
    { names: ["rabbit2"], surrogates: "🐇" },
    { names: ["raccoon"], surrogates: "🦝" },
    { names: ["skunk"], surrogates: "🦨" },
    { names: ["badger"], surrogates: "🦡" },
    { names: ["beaver"], surrogates: "🦫" },
    { names: ["otter"], surrogates: "🦦" },
    { names: ["sloth"], surrogates: "🦥" },
    { names: ["mouse2"], surrogates: "🐁" },
    { names: ["rat"], surrogates: "🐀" },
    { names: ["chipmunk"], surrogates: "🐿️" },
    { names: ["hedgehog"], surrogates: "🦔" },
    ...
    { names: ["feather"], surrogates: "🪶" },
    { names: ["mushroom"], surrogates: "🍄" },
    { names: ["shell"], surrogates: "🐚" },
    { names: ["rock"], surrogates: "🪨" },
    { names: ["wood"], surrogates: "🪵" },
    { names: ["ear_of_rice"], surrogates: "🌾" },
    { names: ["potted_plant"], surrogates: "🪴" },
  ...
  food: [
    ...
    { names: ["dumpling"], surrogates: "🥟" },
    { names: ["oyster"], surrogates: "🦪" },
    ...
    { names: ["fortune_cookie"], surrogates: "🥠" },
    { names: ["moon_cake"], surrogates: "🥮" },
    ...
    { names: ["pie"], surrogates: "🥧" },
    { names: ["cupcake"], surrogates: "🧁" },
    ...
    { names: ["teapot"], surrogates: "🫖" },
    { names: ["mate"], surrogates: "🧉" },
    { names: ["bubble_tea"], surrogates: "🧋" },
    { names: ["beverage_box"], surrogates: "🧃" },
    { names: ["cup_with_straw"], surrogates: "🥤" },
    ...
    { names: ["bowl_with_spoon"], surrogates: "🥣" },
    { names: ["takeout_box"], surrogates: "🥡" },
    { names: ["chopsticks"], surrogates: "🥢" },
    { names: ["salt"], surrogates: "🧂" },
  ],
  activity: [
    ...
    { names: ["skateboard"], surrogates: "🛹" },
    { names: ["roller_skate"], surrogates: "🛼" },
    { names: ["sled"], surrogates: "🛷" },
    { names: ["ice_skate"], surrogates: "⛸️" },
    { names: ["curling_stone"], surrogates: "🥌" },
    { names: ["ski"], surrogates: "🎿" },
    { names: ["skier"], surrogates: "⛷️" },
    {
      names: ["snowboarder"],
      surrogates: "🏂",
      diversityChildren: [
    ...
    { names: ["people_wrestling", "wrestlers", "wrestling"], surrogates: "🤼" },
    { names: ["women_wrestling"], surrogates: "🤼‍♀️" },
    { names: ["men_wrestling"], surrogates: "🤼‍♂️" },
    {
    ...
    { names: ["person_fencing", "fencer", "fencing"], surrogates: "🤺" },
    {
    ...
    },
    {
      ...
      surrogates: "🏇",
      diversityChildren: [
        { names: ["horse_racing_tone1"], surrogates: "🏇🏻" },
        { names: ["horse_racing_tone2"], surrogates: "🏇🏼" },
        { names: ["horse_racing_tone3"], surrogates: "🏇🏽" },
        { names: ["horse_racing_tone4"], surrogates: "🏇🏾" },
        { names: ["horse_racing_tone5"], surrogates: "🏇🏿" },
      ],
    },
    {
    ...
    },
    {
      ...
      surrogates: "🏄",
      diversityChildren: [
        { names: ["person_surfing_tone1", "surfer_tone1"], surrogates: "🏄🏻" },
        { names: ["person_surfing_tone2", "surfer_tone2"], surrogates: "🏄🏼" },
        { names: ["person_surfing_tone3", "surfer_tone3"], surrogates: "🏄🏽" },
        { names: ["person_surfing_tone4", "surfer_tone4"], surrogates: "🏄🏾" },
        { names: ["person_surfing_tone5", "surfer_tone5"], surrogates: "🏄🏿" },
      ],
    },
    {
      names: ["woman_surfing"],
    ...
    { names: ["military_medal"], surrogates: "🎖️" },
    { names: ["rosette"], surrogates: "🏵️" },
    { names: ["reminder_ribbon"], surrogates: "🎗️" },
    { names: ["ticket"], surrogates: "🎫" },
    { names: ["tickets", "admission_tickets"], surrogates: "🎟️" },
  ...
  travel: [
    ...
    { names: ["probing_cane"], surrogates: "🦯" },
    { names: ["manual_wheelchair"], surrogates: "🦽" },
    { names: ["motorized_wheelchair"], surrogates: "🦼" },
    { names: ["scooter"], surrogates: "🛴" },
    { names: ["bike"], surrogates: "🚲" },
    { names: ["motor_scooter", "motorbike"], surrogates: "🛵" },
    { names: ["motorcycle", "racing_motorcycle"], surrogates: "🏍️" },
    { names: ["auto_rickshaw"], surrogates: "🛺" },
    ...
    { names: ["airplane"], surrogates: "✈️" },
    { names: ["airplane_departure"], surrogates: "🛫" },
    { names: ["airplane_arriving"], surrogates: "🛬" },
    { names: ["airplane_small", "small_airplane"], surrogates: "🛩️" },
    { names: ["seat"], surrogates: "💺" },
    { names: ["satellite_orbital"], surrogates: "🛰️" },
    { names: ["rocket"], surrogates: "🚀" },
    { names: ["flying_saucer"], surrogates: "🛸" },
    { names: ["helicopter"], surrogates: "🚁" },
    { names: ["canoe", "kayak"], surrogates: "🛶" },
    { names: ["sailboat"], surrogates: "⛵" },
    { names: ["speedboat"], surrogates: "🚤" },
    { names: ["motorboat"], surrogates: "🛥️" },
    { names: ["cruise_ship", "passenger_ship"], surrogates: "🛳️" },
    { names: ["ferry"], surrogates: "⛴️" },
    ...
    { names: ["map", "world_map"], surrogates: "🗺️" },
    ...
    { names: ["stadium"], surrogates: "🏟️" },
    { names: ["ferris_wheel"], surrogates: "🎡" },
    { names: ["roller_coaster"], surrogates: "🎢" },
    { names: ["carousel_horse"], surrogates: "🎠" },
    { names: ["fountain"], surrogates: "⛲" },
    { names: ["beach_umbrella", "umbrella_on_ground"], surrogates: "⛱️" },
    { names: ["beach", "beach_with_umbrella"], surrogates: "🏖️" },
    { names: ["island", "desert_island"], surrogates: "🏝️" },
    { names: ["desert"], surrogates: "🏜️" },
    { names: ["volcano"], surrogates: "🌋" },
    { names: ["mountain"], surrogates: "⛰️" },
    { names: ["mountain_snow", "snow_capped_mountain"], surrogates: "🏔️" },
    { names: ["mount_fuji"], surrogates: "🗻" },
    { names: ["camping"], surrogates: "🏕️" },
    { names: ["tent"], surrogates: "⛺" },
    { names: ["house"], surrogates: "🏠" },
    { names: ["house_with_garden"], surrogates: "🏡" },
    { names: ["homes", "house_buildings"], surrogates: "🏘️" },
    { names: ["house_abandoned", "derelict_house_building"], surrogates: "🏚️" },
    { names: ["hut"], surrogates: "🛖" },
    { names: ["construction_site", "building_construction"], surrogates: "🏗️" },
    ...
    { names: ["classical_building"], surrogates: "🏛️" },
    { names: ["church"], surrogates: "⛪" },
    { names: ["mosque"], surrogates: "🕌" },
    { names: ["synagogue"], surrogates: "🕍" },
    { names: ["hindu_temple"], surrogates: "🛕" },
    { names: ["kaaba"], surrogates: "🕋" },
    { names: ["shinto_shrine"], surrogates: "⛩️" },
    { names: ["railway_track", "railroad_track"], surrogates: "🛤️" },
    { names: ["motorway"], surrogates: "🛣️" },
    { names: ["japan"], surrogates: "🗾" },
    { names: ["rice_scene"], surrogates: "🎑" },
    { names: ["park", "national_park"], surrogates: "🏞️" },
  ...
  objects: [
    ...
    { names: ["mobile_phone", "iphone"], surrogates: "📱" },
    { names: ["calling"], surrogates: "📲" },
    { names: ["computer"], surrogates: "💻" },
    { names: ["keyboard"], surrogates: "⌨️" },
    { names: ["desktop", "desktop_computer"], surrogates: "🖥️" },
    { names: ["printer"], surrogates: "🖨️" },
    { names: ["mouse_three_button", "three_button_mouse"], surrogates: "🖱️" },
    { names: ["trackball"], surrogates: "🖲️" },
    { names: ["joystick"], surrogates: "🕹️" },
    { names: ["compression"], surrogates: "🗜️" },
    ...
    { names: ["projector", "film_projector"], surrogates: "📽️" },
    { names: ["film_frames"], surrogates: "🎞️" },
    { names: ["telephone_receiver"], surrogates: "📞" },
    { names: ["telephone"], surrogates: "☎️" },
    { names: ["pager"], surrogates: "📟" },
    { names: ["fax"], surrogates: "📠" },
    { names: ["tv"], surrogates: "📺" },
    { names: ["radio"], surrogates: "📻" },
    { names: ["microphone2", "studio_microphone"], surrogates: "🎙️" },
    { names: ["level_slider"], surrogates: "🎚️" },
    { names: ["control_knobs"], surrogates: "🎛️" },
    { names: ["compass"], surrogates: "🧭" },
    { names: ["stopwatch"], surrogates: "⏱️" },
    { names: ["timer", "timer_clock"], surrogates: "⏲️" },
    { names: ["alarm_clock"], surrogates: "⏰" },
    { names: ["clock", "mantlepiece_clock"], surrogates: "🕰️" },
    ...
    { names: ["candle"], surrogates: "🕯️" },
    { names: ["diya_lamp"], surrogates: "🪔" },
    { names: ["fire_extinguisher"], surrogates: "🧯" },
    { names: ["oil", "oil_drum"], surrogates: "🛢️" },
    { names: ["money_with_wings"], surrogates: "💸" },
    { names: ["dollar"], surrogates: "💵" },
    { names: ["yen"], surrogates: "💴" },
    { names: ["euro"], surrogates: "💶" },
    { names: ["pound"], surrogates: "💷" },
    { names: ["coin"], surrogates: "🪙" },
    { names: ["moneybag"], surrogates: "💰" },
    { names: ["credit_card"], surrogates: "💳" },
    { names: ["gem"], surrogates: "💎" },
    { names: ["scales"], surrogates: "⚖️" },
    { names: ["ladder"], surrogates: "🪜" },
    { names: ["toolbox"], surrogates: "🧰" },
    { names: ["screwdriver"], surrogates: "🪛" },
    { names: ["wrench"], surrogates: "🔧" },
    { names: ["hammer"], surrogates: "🔨" },
    { names: ["hammer_pick", "hammer_and_pick"], surrogates: "⚒️" },
    { names: ["tools", "hammer_and_wrench"], surrogates: "🛠️" },
    { names: ["pick"], surrogates: "⛏️" },
    { names: ["nut_and_bolt"], surrogates: "🔩" },
    { names: ["gear"], surrogates: "⚙️" },
    { names: ["bricks"], surrogates: "🧱" },
    { names: ["chains"], surrogates: "⛓️" },
    { names: ["hook"], surrogates: "🪝" },
    { names: ["knot"], surrogates: "🪢" },
    { names: ["magnet"], surrogates: "🧲" },
    { names: ["gun"], surrogates: "🔫" },
    { names: ["bomb"], surrogates: "💣" },
    { names: ["firecracker"], surrogates: "🧨" },
    { names: ["axe"], surrogates: "🪓" },
    { names: ["carpentry_saw"], surrogates: "🪚" },
    { names: ["knife"], surrogates: "🔪" },
    { names: ["dagger", "dagger_knife"], surrogates: "🗡️" },
    { names: ["crossed_swords"], surrogates: "⚔️" },
    { names: ["shield"], surrogates: "🛡️" },
    { names: ["smoking"], surrogates: "🚬" },
    { names: ["coffin"], surrogates: "⚰️" },
    { names: ["headstone"], surrogates: "🪦" },
    { names: ["urn", "funeral_urn"], surrogates: "⚱️" },
    { names: ["amphora"], surrogates: "🏺" },
    { names: ["magic_wand"], surrogates: "🪄" },
    { names: ["crystal_ball"], surrogates: "🔮" },
    { names: ["prayer_beads"], surrogates: "📿" },
    { names: ["nazar_amulet"], surrogates: "🧿" },
    { names: ["barber"], surrogates: "💈" },
    { names: ["alembic"], surrogates: "⚗️" },
    { names: ["telescope"], surrogates: "🔭" },
    { names: ["microscope"], surrogates: "🔬" },
    { names: ["hole"], surrogates: "🕳️" },
    { names: ["window"], surrogates: "🪟" },
    { names: ["adhesive_bandage"], surrogates: "🩹" },
    { names: ["stethoscope"], surrogates: "🩺" },
    { names: ["pill"], surrogates: "💊" },
    { names: ["syringe"], surrogates: "💉" },
    { names: ["drop_of_blood"], surrogates: "🩸" },
    { names: ["dna"], surrogates: "🧬" },
    { names: ["microbe"], surrogates: "🦠" },
    { names: ["petri_dish"], surrogates: "🧫" },
    { names: ["test_tube"], surrogates: "🧪" },
    { names: ["thermometer"], surrogates: "🌡️" },
    { names: ["mouse_trap"], surrogates: "🪤" },
    { names: ["broom"], surrogates: "🧹" },
    { names: ["basket"], surrogates: "🧺" },
    { names: ["sewing_needle"], surrogates: "🪡" },
    { names: ["roll_of_paper"], surrogates: "🧻" },
    { names: ["toilet"], surrogates: "🚽" },
    { names: ["plunger"], surrogates: "🪠" },
    { names: ["bucket"], surrogates: "🪣" },
    ...
    { names: ["bathtub"], surrogates: "🛁" },
    {
      ...
      surrogates: "🛀",
      diversityChildren: [
        { names: ["bath_tone1"], surrogates: "🛀🏻" },
        { names: ["bath_tone2"], surrogates: "🛀🏼" },
        { names: ["bath_tone3"], surrogates: "🛀🏽" },
        { names: ["bath_tone4"], surrogates: "🛀🏾" },
        { names: ["bath_tone5"], surrogates: "🛀🏿" },
      ],
    },
    { names: ["toothbrush"], surrogates: "🪥" },
    { names: ["soap"], surrogates: "🧼" },
    { names: ["razor"], surrogates: "🪒" },
    { names: ["sponge"], surrogates: "🧽" },
    { names: ["squeeze_bottle"], surrogates: "🧴" },
    { names: ["bellhop", "bellhop_bell"], surrogates: "🛎️" },
    { names: ["key"], surrogates: "🔑" },
    { names: ["key2", "old_key"], surrogates: "🗝️" },
    { names: ["door"], surrogates: "🚪" },
    { names: ["chair"], surrogates: "🪑" },
    { names: ["mirror"], surrogates: "🪞" },
    { names: ["couch", "couch_and_lamp"], surrogates: "🛋️" },
    { names: ["bed"], surrogates: "🛏️" },
    {
    ...
    { names: ["teddy_bear"], surrogates: "🧸" },
    { names: ["frame_photo", "frame_with_picture"], surrogates: "🖼️" },
    { names: ["shopping_bags"], surrogates: "🛍️" },
    ...
    { names: ["placard"], surrogates: "🪧" },
    { names: ["scroll"], surrogates: "📜" },
    { names: ["page_with_curl"], surrogates: "📃" },
    { names: ["page_facing_up"], surrogates: "📄" },
    { names: ["bookmark_tabs"], surrogates: "📑" },
    { names: ["receipt"], surrogates: "🧾" },
    { names: ["bar_chart"], surrogates: "📊" },
    { names: ["chart_with_upwards_trend"], surrogates: "📈" },
    { names: ["chart_with_downwards_trend"], surrogates: "📉" },
    { names: ["notepad_spiral", "spiral_note_pad"], surrogates: "🗒️" },
    { names: ["calendar_spiral", "spiral_calendar_pad"], surrogates: "🗓️" },
    { names: ["calendar"], surrogates: "📆" },
    { names: ["date"], surrogates: "📅" },
    { names: ["wastebasket"], surrogates: "🗑️" },
    { names: ["card_index"], surrogates: "📇" },
    { names: ["card_box", "card_file_box"], surrogates: "🗃️" },
    { names: ["ballot_box", "ballot_box_with_ballot"], surrogates: "🗳️" },
    { names: ["file_cabinet"], surrogates: "🗄️" },
    { names: ["clipboard"], surrogates: "📋" },
    { names: ["file_folder"], surrogates: "📁" },
    { names: ["open_file_folder"], surrogates: "📂" },
    { names: ["dividers", "card_index_dividers"], surrogates: "🗂️" },
    { names: ["newspaper2", "rolled_up_newspaper"], surrogates: "🗞️" },
    ...
    { names: ["safety_pin"], surrogates: "🧷" },
    { names: ["link"], surrogates: "🔗" },
    { names: ["paperclip"], surrogates: "📎" },
    { names: ["paperclips", "linked_paperclips"], surrogates: "🖇️" },
    { names: ["triangular_ruler"], surrogates: "📐" },
    { names: ["straight_ruler"], surrogates: "📏" },
    { names: ["abacus"], surrogates: "🧮" },
    { names: ["pushpin"], surrogates: "📌" },
    { names: ["round_pushpin"], surrogates: "📍" },
    { names: ["scissors"], surrogates: "✂️" },
    { names: ["pen_ballpoint", "lower_left_ballpoint_pen"], surrogates: "🖊️" },
    { names: ["pen_fountain", "lower_left_fountain_pen"], surrogates: "🖋️" },
    { names: ["black_nib"], surrogates: "✒️" },
    { names: ["paintbrush", "lower_left_paintbrush"], surrogates: "🖌️" },
    { names: ["crayon", "lower_left_crayon"], surrogates: "🖍️" },
    { names: ["pencil", "memo"], surrogates: "📝" },
    { names: ["pencil2"], surrogates: "✏️" },
  ...
  symbols: [
    ...
    { names: ["brown_heart"], surrogates: "🤎" },
    { names: ["white_heart"], surrogates: "🤍" },
    ...
    { names: ["mending_heart"], surrogates: "❤️‍🩹" },
    { names: ["heart_on_fire"], surrogates: "❤️‍🔥" },
    { names: ["heart_decoration"], surrogates: "💟" },
    { names: ["peace", "peace_symbol"], surrogates: "☮️" },
    { names: ["cross", "latin_cross"], surrogates: "✝️" },
    { names: ["star_and_crescent"], surrogates: "☪️" },
    { names: ["om_symbol"], surrogates: "🕉️" },
    { names: ["wheel_of_dharma"], surrogates: "☸️" },
    { names: ["star_of_david"], surrogates: "✡️" },
    { names: ["six_pointed_star"], surrogates: "🔯" },
    { names: ["menorah"], surrogates: "🕎" },
    { names: ["yin_yang"], surrogates: "☯️" },
    { names: ["orthodox_cross"], surrogates: "☦️" },
    ...
    { names: ["id"], surrogates: "🆔" },
    { names: ["atom", "atom_symbol"], surrogates: "⚛️" },
    { names: ["accept"], surrogates: "🉑" },
    { names: ["radioactive", "radioactive_sign"], surrogates: "☢️" },
    { names: ["biohazard", "biohazard_sign"], surrogates: "☣️" },
    ...
    { names: ["u6708"], surrogates: "🈷️" },
    { names: ["eight_pointed_black_star"], surrogates: "✴️" },
    { names: ["vs"], surrogates: "🆚" },
    { names: ["white_flower"], surrogates: "💮" },
    { names: ["ideograph_advantage"], surrogates: "🉐" },
    { names: ["secret"], surrogates: "㊙️" },
    { names: ["congratulations"], surrogates: "㊗️" },
    { names: ["u5408"], surrogates: "🈴" },
    { names: ["u6e80"], surrogates: "🈵" },
    { names: ["u5272"], surrogates: "🈹" },
    { names: ["u7981"], surrogates: "🈲" },
    { names: ["a"], surrogates: "🅰️" },
    { names: ["b"], surrogates: "🅱️" },
    { names: ["ab"], surrogates: "🆎" },
    { names: ["cl"], surrogates: "🆑" },
    { names: ["o2"], surrogates: "🅾️" },
    ...
    { names: ["bangbang"], surrogates: "‼️" },
    { names: ["interrobang"], surrogates: "⁉️" },
    { names: ["low_brightness"], surrogates: "🔅" },
    { names: ["high_brightness"], surrogates: "🔆" },
    { names: ["part_alternation_mark"], surrogates: "〽️" },
    { names: ["warning"], surrogates: "⚠️" },
    { names: ["children_crossing"], surrogates: "🚸" },
    { names: ["trident"], surrogates: "🔱" },
    { names: ["fleur_de_lis"], surrogates: "⚜️" },
    { names: ["beginner"], surrogates: "🔰" },
    { names: ["recycle"], surrogates: "♻️" },
    { names: ["white_check_mark"], surrogates: "✅" },
    { names: ["u6307"], surrogates: "🈯" },
    { names: ["chart"], surrogates: "💹" },
    { names: ["sparkle"], surrogates: "❇️" },
    { names: ["eight_spoked_asterisk"], surrogates: "✳️" },
    ...
    { names: ["information_source"], surrogates: "ℹ️" },
    ...
    { names: ["zero"], surrogates: "0️⃣" },
    { names: ["one"], surrogates: "1️⃣" },
    { names: ["two"], surrogates: "2️⃣" },
    { names: ["three"], surrogates: "3️⃣" },
    { names: ["four"], surrogates: "4️⃣" },
    { names: ["five"], surrogates: "5️⃣" },
    { names: ["six"], surrogates: "6️⃣" },
    { names: ["seven"], surrogates: "7️⃣" },
    { names: ["eight"], surrogates: "8️⃣" },
    { names: ["nine"], surrogates: "9️⃣" },
    { names: ["keycap_ten"], surrogates: "🔟" },
    { names: ["1234"], surrogates: "🔢" },
    { names: ["hash"], surrogates: "#️⃣" },
    { names: ["asterisk", "keycap_asterisk"], surrogates: "*️⃣" },
    { names: ["eject", "eject_symbol"], surrogates: "⏏️" },
    { names: ["arrow_forward"], surrogates: "▶️" },
    { names: ["pause_button", "double_vertical_bar"], surrogates: "⏸️" },
    { names: ["play_pause"], surrogates: "⏯️" },
    { names: ["stop_button"], surrogates: "⏹️" },
    { names: ["record_button"], surrogates: "⏺️" },
    { names: ["track_next", "next_track"], surrogates: "⏭️" },
    { names: ["track_previous", "previous_track"], surrogates: "⏮️" },
    { names: ["fast_forward"], surrogates: "⏩" },
    { names: ["rewind"], surrogates: "⏪" },
    { names: ["arrow_double_up"], surrogates: "⏫" },
    { names: ["arrow_double_down"], surrogates: "⏬" },
    { names: ["arrow_backward"], surrogates: "◀️" },
    { names: ["arrow_up_small"], surrogates: "🔼" },
    { names: ["arrow_down_small"], surrogates: "🔽" },
    { names: ["arrow_right"], surrogates: "➡️" },
    { names: ["arrow_left"], surrogates: "⬅️" },
    { names: ["arrow_up"], surrogates: "⬆️" },
    { names: ["arrow_down"], surrogates: "⬇️" },
    { names: ["arrow_upper_right"], surrogates: "↗️" },
    { names: ["arrow_lower_right"], surrogates: "↘️" },
    { names: ["arrow_lower_left"], surrogates: "↙️" },
    { names: ["arrow_upper_left"], surrogates: "↖️" },
    { names: ["arrow_up_down"], surrogates: "↕️" },
    { names: ["left_right_arrow"], surrogates: "↔️" },
    { names: ["arrow_right_hook"], surrogates: "↪️" },
    { names: ["leftwards_arrow_with_hook"], surrogates: "↩️" },
    { names: ["arrow_heading_up"], surrogates: "⤴️" },
    { names: ["arrow_heading_down"], surrogates: "⤵️" },
    ...
    { names: ["heavy_multiplication_x"], surrogates: "✖️" },
    { names: ["infinity"], surrogates: "♾️" },
    { names: ["heavy_dollar_sign"], surrogates: "💲" },
    { names: ["currency_exchange"], surrogates: "💱" },
    { names: ["tm"], surrogates: "™️" },
    { names: ["copyright"], surrogates: "©️" },
    { names: ["registered"], surrogates: "®️" },
    { names: ["wavy_dash"], surrogates: "〰️" },
    ...
    { names: ["heavy_check_mark"], surrogates: "✔️" },
    { names: ["ballot_box_with_check"], surrogates: "☑️" },
    { names: ["radio_button"], surrogates: "🔘" },
    { names: ["white_circle"], surrogates: "⚪" },
    { names: ["black_circle"], surrogates: "⚫" },
    { names: ["red_circle"], surrogates: "🔴" },
    { names: ["blue_circle"], surrogates: "🔵" },
    { names: ["brown_circle"], surrogates: "🟤" },
    { names: ["purple_circle"], surrogates: "🟣" },
    { names: ["green_circle"], surrogates: "🟢" },
    { names: ["yellow_circle"], surrogates: "🟡" },
    { names: ["orange_circle"], surrogates: "🟠" },
    ...
    { names: ["black_small_square"], surrogates: "▪️" },
    { names: ["white_small_square"], surrogates: "▫️" },
    { names: ["black_medium_small_square"], surrogates: "◾" },
    { names: ["white_medium_small_square"], surrogates: "◽" },
    { names: ["black_medium_square"], surrogates: "◼️" },
    { names: ["white_medium_square"], surrogates: "◻️" },
    { names: ["black_large_square"], surrogates: "⬛" },
    { names: ["white_large_square"], surrogates: "⬜" },
    { names: ["orange_square"], surrogates: "🟧" },
    { names: ["blue_square"], surrogates: "🟦" },
    { names: ["red_square"], surrogates: "🟥" },
    { names: ["brown_square"], surrogates: "🟫" },
    { names: ["purple_square"], surrogates: "🟪" },
    { names: ["green_square"], surrogates: "🟩" },
    { names: ["yellow_square"], surrogates: "🟨" },
    ...
    { names: ["speech_left", "left_speech_bubble"], surrogates: "🗨️" },
    { names: ["eye_in_speech_bubble"], surrogates: "👁‍🗨" },
    { names: ["speech_balloon"], surrogates: "💬" },
    { names: ["thought_balloon"], surrogates: "💭" },
    { names: ["anger_right", "right_anger_bubble"], surrogates: "🗯️" },
    { names: ["spades"], surrogates: "♠️" },
    { names: ["clubs"], surrogates: "♣️" },
    { names: ["hearts"], surrogates: "♥️" },
    { names: ["diamonds"], surrogates: "♦️" },
    ...
    { names: ["female_sign"], surrogates: "♀️" },
    { names: ["male_sign"], surrogates: "♂️" },
    { names: ["transgender_symbol"], surrogates: "⚧" },
    { names: ["medical_symbol"], surrogates: "⚕️" },
  ...
  flags: [
    { names: ["flag_white"], surrogates: "🏳️" },
    { names: ["flag_black"], surrogates: "🏴" },
    { names: ["checkered_flag"], surrogates: "🏁" },
    { names: ["triangular_flag_on_post"], surrogates: "🚩" },
    { names: ["rainbow_flag", "gay_pride_flag"], surrogates: "🏳️‍🌈" },
    { names: ["transgender_flag"], surrogates: "🏳️‍⚧️" },
    { names: ["pirate_flag"], surrogates: "🏴‍☠️" },
    ...
    { names: ["england"], surrogates: "🏴󠁧󠁢󠁥󠁮󠁧󠁿" },
    { names: ["scotland"], surrogates: "🏴󠁧󠁢󠁳󠁣󠁴󠁿" },
    { names: ["wales"], surrogates: "🏴󠁧󠁢󠁷󠁬󠁳󠁿" },
    ...
    { names: ["united_nations"], surrogates: "🇺🇳" },
  ],
};
