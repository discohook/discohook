  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className={`rounded border min-h-[36px] max-h-9 py-0 px-[14px] bg-gray-300 border-gray-200 placeholder-gray-500 focus:border-blurple-500 dark:border-gray-600 dark:bg-gray-700 dark:placeholder-gray-400 invalid:border-rose-400 dark:invalid:border-rose-400 transition ${
          props.className ?? ""
        }`}
      />
      {props.errors &&
