  ...
  return (
    <label className="block">
      ...
      <textarea
        ...
        className={`rounded border bg-gray-200 border-gray-100 focus:border-blurple-500 dark:border-gray-600 dark:bg-gray-700 p-2 invalid:border-rose-400 dark:invalid:border-rose-400 transition ${
          props.className ?? ""
        }`}
      />
      {props.errors &&
